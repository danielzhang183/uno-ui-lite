import type { Preset, RuleContext, UserConfig } from '@unocss/core'
...
export function unocssPreset(): Preset {
  return {
    ...
    shortcuts: {
      ...
      // card
      'd-card-base': 'border d-border-base rounded d-bg-base shadow-sm',

      // header
      'd-header-upper': 'text-sm uppercase mb-2 leading-1.2em tracking-wide op50',

      // button
      'd-button-base': 'border d-border-base rounded shadow-sm px-1em py-0.25em inline-flex items-center gap-1 op80 !outline-none touch-manipulation',
      ...
      'd-checkbox-box': 'border d-border-base w-1.1em h-1.1em mr-1 text-white flex flex-none items-center rounded-sm overflow-visible',
      'd-checkbox-box-checked': 'bg-context border-context',
      'd-checkbox-icon': 'carbon-checkmark w-1em h-1em m-auto',

      // radio
      'd-radio-box': 'border d-border-base w-1.2em h-1.2em mr-1 text-white flex flex-none rounded-full overflow-visible',
      ...
      'd-switch-slider': 'mr-1 rounded-full border d-border-base relative p-2px',
      'd-switch-slider-checked': 'border-context/20 bg-context/10',
      'd-switch-thumb': 'h-1em w-1em rounded-1/2 border d-border-base ml-0 mr-0.8em',
      ...
      // icon-button
      'd-icon-button': 'aspect-1/1 w-1.6em h-1.6em flex items-center justify-center rounded op50 hover:op100 hover:d-bg-active',

      // loading
      'd-loading': 'flex h-full w-full justify-center items-center',
      'd-panel-grids': 'd-panel-grids-light dark:d-panel-grids-dark flex flex-col h-full gap-2 items-center justify-center',
    },
  }
}
